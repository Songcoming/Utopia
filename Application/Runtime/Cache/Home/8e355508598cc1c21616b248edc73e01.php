...
<div class="container">
	<div class="thumbnail">
		...
		<div class="caption">
      <h3>Up: <a href="/ThinkPHP/index.php/home/show/usershow/uid/<?php echo ($uid); ?>"><?php echo ($author); ?></a> <small><?php echo ($ptime); ?></small></h3>
      <?php echo ($tags); ?>
    </div>
	</div>
	<hr>
	<h3>Comments (<?php echo ($cnumber); ?>):</h3>
	<ul class="media-list">
		<?php echo ($comments); ?>
	</ul>
	<h3>Your Comment:</h3>
	<form action="/ThinkPHP/index.php/home/user/upcomment/uid/<?php echo ($cuid); ?>/pid/<?php echo ($pid); ?>" method="post" role="form">
		<div class="form-group">
      <label for="author">Your name:</label>
			<div class="radio" id="author" name="radio">
			  <?php echo ($cauthor); ?>
			  <label>
			    <input type="radio" name="optionsRadios" value="option2">Guest
			  </label>
			</div>
	  </div>
	  <div class="form-group">
	  	<label for="cmcontent">comment:</label>
      <textarea type="text" class="form-control" name="comment" id="cmtcontent" rows="3">
      </textarea> 
	  </div>
